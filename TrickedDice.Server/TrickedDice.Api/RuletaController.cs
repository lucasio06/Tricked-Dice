    ...
    public class RuletaController : ControllerBase
    {
        ...
        public IActionResult Girar([FromBody] ApuestaModel apuesta)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                string sqlSaldo = "SELECT SALDO FROM USUARIO WHERE EMAIL = @Email";
                using (var cmd = new SqlCommand(sqlSaldo, connection))
                {
                ...
                switch (tipo)
                {
                    ...
                    case "finales":
                        ...
                        break;
                    default:
                        _logger.LogWarning("Tipo de apuesta no reconocido: {Tipo}", tipo);
                ...
                string sqlUpdate = "UPDATE USUARIO SET SALDO = @Saldo WHERE EMAIL = @Email";
